...
function chargerLesSprites(){
	...
	loadSprite("2001 l'Odyssée de l'espace","sprites/affiches/2001_A_Space_Odyssey_(1968) (1).png")
	...
	loadSprite("Le Lys brisé","sprites/affiches/Broken_blossoms_poster200.png")
	...
	loadSprite("Les Passagers de la nuit","sprites/affiches/Dark_Passage_(film)_poster (1).jpg")
	...
	loadSprite("Planète interdite","sprites/affiches/forbbidenPlanet (1).jpg")
	...
	loadSprite("L'Homme à la camera","sprites/affiches/hommeCamera1929.jpg")
	...
	loadSprite("La Télégraphiste de Lonedale","sprites/affiches/lonedaleOperator1911 (1).jpg")
	...
	loadSprite("Les Nuits de Cabiria","sprites/affiches/Nights_of_Cabiria_Poster (1).jpg")
	...
	loadSprite("Charlot rentre tard","sprites/affiches/One_A.M._poster (1).jpg")
	...
	loadSprite("Le Facteur sonne toujours deux fois","sprites/affiches/PostmanAlwaysPoster1946 (1).jpg")
	...
	loadSprite("Le Chanteur de jazz","sprites/affiches/The_Jazz_Singer_1927_Poster (1).jpg")
	...
	loadSprite("La naissance la vie et la mort de notre Seigneur Jesus Christ","sprites/affiches/vieduchrist.jpg")
	//loadSprite("Les Enfants du Paradis","sprites/affiches/vignette_les-enfants-du-paradis (1).jpg")
	loadSprite("L'Opinion publique","sprites/affiches/womanOfParis1923.jpg")
	loadSprite("Charlot apprenti","sprites/affiches/work1915 (1).jpg")
	...
	loadSprite("Cinq pieces faciles","sprites/affiches/1974_-_Colonial_Theater_Ad_-_28_May_MC_-_Allentown_PA (1).jpg")
	loadSprite("Les Dix Commandements 1956","sprites/affiches/1024px-The_Ten_Commandments_(1956_film_poster) (1).jpg")
	loadSprite("Adieu Philippine","sprites/affiches/Adieu Philippine (1).jpg")
	loadSprite("Aelita","sprites/affiches/Aelita (1).jpg")
	loadSprite("Allemagne année zéro","sprites/affiches/Allemagne Année Zéro (1).jpg")
	loadSprite("Allo Berlin Ici Paris !","sprites/affiches/Allo Berlin Ici Paris (1).jpg")
	loadSprite("Assurance sur la mort","sprites/affiches/Assurance sur la mort (1).jpg")
	loadSprite("Bande a part","sprites/affiches/Bande à part (1) (1).jpg")
	loadSprite("Ben Hur","sprites/affiches/Ben-Hur (1).jpg")
	loadSprite("Broadway Melody","sprites/affiches/Broadway Melody (1) (1).jpg")
	loadSprite("Conversation secrète","sprites/affiches/Conversation secrète (1).jpg")
	loadSprite("Serenade a trois","sprites/affiches/Design for living (1).jpg")
	loadSprite("Et pour quelques dollars de plus","sprites/affiches/Et pour quelques dollars de plus (1).jpg")
	loadSprite("Fantomas Episode 1 Le Mort qui tue","sprites/affiches/Fantômas 1 (1).jpg")
	loadSprite("Fantomas Episode 2 Juve contre Fantomas","sprites/affiches/Fantômas 2 (1).jpg")
	loadSprite("Jules et Jim","sprites/affiches/Jules et Jim (1).jpg")
	loadSprite("L'Argent","sprites/affiches/L'Argent (1).jpg")
	loadSprite("L'Assassinat du duc de Guise","sprites/affiches/L'Assassinat du Duc de Guise (1).jpg")
	loadSprite("L'Homme qui en savait trop","sprites/affiches/L'Homme qui en savait trop (1).jpg")
	loadSprite("L'Homme qui tua Liberty Valance","sprites/affiches/L'Homme qui tua Liberty Valance (1).jpg")
	loadSprite("La Croisiere du Navigator","sprites/affiches/La Croisière du Navigator (1).jpg")
	loadSprite("La Mere","sprites/affiches/La Mère (1).jpg")
	loadSprite("La Prisonnière du désert","sprites/affiches/La Prisonnière du désert (1).jpg")
	loadSprite("La Souriante Madame Beudet","sprites/affiches/La Souriante Madame Beudet (1).jpg")
	loadSprite("La Tunique","sprites/affiches/La Tunique (1).jpg")
	loadSprite("La Vérité sur bébé Donge","sprites/affiches/La Vérité sur bébé Donge (1).jpg")
	loadSprite("Le Blé en herbe","sprites/affiches/Le Blé en herbe (1).jpg")
	loadSprite("Le Cabinet du Dr. Caligari","sprites/affiches/Le Cabinet du Dr Caligari (1).jpg")
	loadSprite("Le Diable au corps","sprites/affiches/Le Diable au corps (1).jpg")
	loadSprite("Le Golem","sprites/affiches/Le Golem (1).jpg")
	loadSprite("Le Train sifflera trois fois","sprites/affiches/Le Train sifflera trois fois (1).jpg")
	loadSprite("Les Derniers jours de Pompei","sprites/affiches/Les Derniers jours de Pompéi (1).jpg")
	loadSprite("Les Dix Commandements 1923","sprites/affiches/Les Dix Commandements 1923 (1).jpg")
	loadSprite("Monte la dessus","sprites/affiches/Monte là-dessus (1).jpg")
	loadSprite("Octobre","sprites/affiches/Octobre (1).jpg")
	loadSprite("Pièges","sprites/affiches/Pièges (1).jpg")
	loadSprite("Rapt","sprites/affiches/Rapt (2).jpg")
	loadSprite("Rocco et ses frères","sprites/affiches/Rocco et ses frères (1).jpg")
	loadSprite("THX 1138","sprites/affiches/THX 1138 (1).jpg")
	loadSprite("Tout ce que le ciel permet","sprites/affiches/Tout ce que le ciel permet (1).jpg")
}
chargerLesSprites()
